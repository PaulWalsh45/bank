...
namespace DBSBank.BankDataSet1TableAdapters {
...
SELECT AccountId, FirstName, Surname, Email, Phone, Address1, Address2, City, County, AccountType, AccountNumber, SortCode, InitialBalance, Overdraft FROM Accounts WHERE (AccountId = SCOPE_IDENTITY())";
        ...
        public virtual int Fill(BankDataSet1.AccountsDataTable dataTable) {
        ...
        public virtual BankDataSet1.AccountsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BankDataSet1.AccountsDataTable dataTable = new BankDataSet1.AccountsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BankDataSet1.AccountsDataTable dataTable) {
